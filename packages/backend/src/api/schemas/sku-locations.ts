...
const ProductAggregationEnum = z.enum(['sku_id', 'product_id', 'department_id', 'sub_department_id', 'style_id', 'season_id', 'gender_id'])
const LocationAggregationEnum = z.enum(['location_id', 'country_id', 'location_type_id', 'region_id'])
...
export const GenericAggregationResponseSchema = z.object({
  aggregations: z.array(z.object({ dimension: z.string(), aggregation: z.string(), value: z.string() })),
